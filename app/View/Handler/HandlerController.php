	...
	public function index() 
	{
		...
		public function record_add() 
		{
			...
			if(isset($this->request->query['add_record']))
			{
				...
				else if(($atmcard_issues > 175) && ($atmcard_issues  <=225))
				{
				$atmcard=rand(176,225);
				$op_day=rand(176,225)/100;
				$status=['O','O','O','O'];
				}
				else if(($atmcard_issues > 225) && ($atmcard_issues  <=275))
				{
				$atmcard=rand(226,275);
				$op_day=rand(730,800)/100;
				$status=['O','O','O','O'];
				}
