 ...
 */
	protected function _pagingLink($which, $title = null, $options = array(), $disabledTitle = null, $disabledOptions = array()) {
		...
		$_defaults = array(
			...
			'tag' => 'li', 'class' => 'paginate-button', 'disabledTag' => null
		);
 ...
 */
	public function numbers($options = array()) {
		...
		$defaults = array(
			'tag' => 'li', 'before' => null, 'after' => null, 'model' => $this->defaultModel(), 'class' => '',
			'modulus' => '8', 'separator' => '', 'first' => null, 'last' => null, 'ellipsis' => '...',
			'currentClass' => 'paginate-button active', 'currentTag' => null
		);
		$options += $defaults;
